...
def run():
    ...
    list_1 = [file_transfer_pb2.FileUploadData(fileName="antergos.iso", data=fud.data, chunkId = 1, maxChunks = 3) for fud in list_1]
    list_2 = [file_transfer_pb2.FileUploadData(fileName="antergos.iso", data=fud.data, chunkId = 2, maxChunks = 3) for fud in list_2]
    list_3 = [file_transfer_pb2.FileUploadData(fileName="antergos.iso", data=fud.data, chunkId = 3, maxChunks = 3) for fud in list_3]
