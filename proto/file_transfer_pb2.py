...
_FILEUPLOADINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='maxChunks', full_name='grpc.FileUploadInfo.maxChunks', index=2,
...
_FILEUPLOADDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='maxChunks', full_name='grpc.FileUploadData.maxChunks', index=5,
